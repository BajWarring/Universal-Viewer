...
class TaskProgressDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Dialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)), // JSON spec mapped to xl
              ...
              children: [
                Expanded(
                  child: FilledButton.tonal(
                    onPressed: () => Navigator.pop(context), // Hides dialog but isolate keeps running
